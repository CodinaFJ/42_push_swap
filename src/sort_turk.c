...
/*   Updated: 2024/01/12 13:28:21 by jcodina-         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
size_t	calculate_cost(const t_stack_i *stack_a, const t_stack_i *stack_b, size_t index_a, size_t index_b)
{
	t_n_moves		moves;
	t_moves_combs	moves_combs;
	size_t			min_moves;
...
size_t	select_best_candidate(const t_stack_i *stack_a, const t_stack_i *stack_b)
{
	size_t	i;
	size_t	aux;
	size_t	min_cost;
...
size_t	select_best_candidate_back(const t_stack_i *stack_a, const t_stack_i *stack_b)
{
	size_t	i;
	size_t	aux;
	size_t	min_cost;
	...
	//ft_printf("The best candidate is index %d (%d) with a cost of %d\n", max_idx - stack_a->bottom, stack_a->array[max_idx % stack_a->capacity], min_cost);
	return (max_idx);
}
